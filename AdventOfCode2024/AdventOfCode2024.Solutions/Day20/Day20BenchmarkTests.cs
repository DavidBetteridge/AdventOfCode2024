...
public class Day20BenchmarkTests
{
    ...
    [BenchmarkCategory("Part1")]
    public void Day20_Part1b()
    {
        var solver = new Day20_Part2();
        var answer = solver.Part2("/Users/davidbetteridge/Personal/AdventOfCode2024/AdventOfCode2024/AdventOfCode2024.Tests/Day20/input.txt", 100, 2);
        if (answer != 1507) throw new Exception("Wrong answer");
    }
    ...
    {
        var solver = new Day20_Part2();
        var answer = solver.Part2("/Users/davidbetteridge/Personal/AdventOfCode2024/AdventOfCode2024/AdventOfCode2024.Tests/Day20/input.txt", 100, 20);
